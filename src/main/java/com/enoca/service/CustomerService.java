...
public class CustomerService {
    ...
    public ResponseMessage<CustomerResponse> addCustomer(CustomerRequest customerRequest) {
        ...
        boolean isExistByEmail = customerRepository.existsByEmail(email); //email unique mi diye kontrol ettik
        if (isExistByEmail){
        ...
        // Customer oluşturulduğunda otomatik olarak ona ait bir Cart oluşuyor
        Cart cart = new Cart();
